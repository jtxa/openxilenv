...
The following PIP packages are mandatory.
...
The script `automationExample.py` demonstrates how to use the **OpenXilEnv** package. Keep in mind that you must modify the variables `xilEnvInstallationPath` and `electricCarIniFilePath` to their correct paths in your case.
